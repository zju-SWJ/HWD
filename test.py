...
from dataset.datasets import CSTestSet, VOCDataTestSet, ADETestSet, COCOTestSet
...
def parse_args():
    ...
    # checkpoint and log
    parser.add_argument('--pretrained', type=str, default='psp_resnet18_citys_cirkd_best_model.pth', help='pretrained seg model')
    parser.add_argument('--save-dir', default='./logs/', help='Directory for saving predictions')
...
class Evaluator(object):
    def __init__(self, args, num_gpus):
        ...
        if args.dataset == 'citys':
            self.val_dataset = CSTestSet(DATA_CS, DATALIST_CS_TEST)
        elif args.dataset == 'voc':
            self.val_dataset = VOCDataTestSet(DATA_VOC, DATALIST_VOC_TEST)
        elif args.dataset == 'ade20k':
            self.val_dataset = ADETestSet(DATA_ADE20K_TEST, DATALIST_ADE20K_TEST)
        elif args.dataset == 'coco':
            self.val_dataset = COCOTestSet(DATA_COCO_TEST, DATALIST_COCO_TEST)
...
if __name__ == '__main__':
    ...
    logger = setup_logger("semantic_segmentation", args.save_dir, get_rank(),
                filename='{}_{}_{}_{}_test.txt'.format(
