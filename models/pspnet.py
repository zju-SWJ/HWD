...
class PSPNet(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet50', aux=False, local_rank=None, pretrained_base='None', **kwargs):
...
def get_psp(backbone='resnet50', local_rank=None,  pretrained='None', pretrained_base='None', num_class=19, **kwargs):
...
if __name__ == '__main__':
    model = get_psp('resnet50')
    img = torch.randn(2, 3, 512, 512)
    output = model(img)
    print(output[-1].size())
    # resnet18 (2, 128, 64, 64)
    # resnet50 (2, 512, 64, 64)
