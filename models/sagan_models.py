...
class Discriminator(nn.Module):
    ...
    def __init__(self, preprocess_GAN_mode, input_channel=19, image_size=64, conv_dim=64, norm_layer=nn.SyncBatchNorm):
        ...
        if preprocess_GAN_mode == 1: #'bn':
            self.preprocess_additional = norm_layer(input_channel)
