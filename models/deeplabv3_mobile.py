...
class DeepLabV3(nn.Module):
    def __init__(self, nclass, local_rank=None, pretrained_base=True, **kwargs):
...
def get_deeplabv3_mobile(local_rank=None, pretrained='None', pretrained_base='None', num_class=19, **kwargs):
    model = DeepLabV3(num_class, local_rank=local_rank, pretrained_base=pretrained_base, **kwargs)
    if pretrained != 'None':
...
if __name__ == '__main__':
    model = get_deeplabv3_mobile(norm_layer=nn.BatchNorm2d)
