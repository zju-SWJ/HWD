...
__all__ = ['ResNetV1b', 'resnet18_v1s', 'resnet50_v1s', 'resnet101_v1s']
...
def resnet18_v1s(pretrained='None', local_rank=None, **kwargs):
...
def resnet50_v1s(pretrained='None', local_rank=None, **kwargs):
...
def resnet101_v1s(pretrained='None', local_rank=None, **kwargs):
...
if __name__ == '__main__':
    ...
    output = model(img)
    print(output.size())
    # resnet18 (1, 512, 64, 64)
    # resnet50, resnet101 (1, 2048, 64, 64)
