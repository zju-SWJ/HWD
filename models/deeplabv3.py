...
def get_deeplabv3(backbone='resnet50', local_rank=None, pretrained='None', pretrained_base='None', num_class=19, **kwargs):
...
if __name__ == '__main__':
    model = get_deeplabv3(backbone='resnet18')
    img = torch.randn(2, 3, 512, 512)
    output = model(img)
    print(output[-1].size())
    # resnet18 (2, 128, 64, 64)
    # resnet50 (2, 256, 64, 64)