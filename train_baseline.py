...
def parse_args():
    ...
    parser.add_argument('--pretrained-base', type=str, default='./pretrained/resnet18-imagenet.pth', help='pretrained backbone')
    parser.add_argument('--pretrained', type=str, default='None', help='pretrained seg model')
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model = get_segmentation_model(model=args.model, backbone=args.backbone, local_rank=args.local_rank,
                                            pretrained=args.pretrained, pretrained_base=args.pretrained_base,
    ...
    def train(self):
        ...
        for iteration,  (images, targets, _) in enumerate(self.train_loader):
            ...
            if iteration % log_per_iters == 0 and save_to_disk:
                logger.info("Iters: {:d}/{:d} || Lr: {:.6f} || Task Loss: {:.4f} || Cost Time: {} || Estimated Time: {}".format(
...
if __name__ == '__main__':
    ...
    logger = setup_logger("semantic_segmentation", args.log_dir, get_rank(), 
                filename='baseline_{}_{}_{}_log.txt'.format(args.model, args.backbone, args.dataset))
