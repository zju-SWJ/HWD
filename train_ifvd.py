...
def save_checkpoint(model, args, is_best=False):
    ...
    filename = 'ifvd_{}_{}_{}.pth'.format(args.student_model, args.student_backbone, args.dataset)
    ...
    if is_best:
        best_filename = 'ifvd_{}_{}_{}_best_model.pth'.format(args.student_model, args.student_backbone, args.dataset)
...
if __name__ == '__main__':
    ...
    logger = setup_logger("semantic_segmentation", args.log_dir, get_rank(), 
        filename='ifvd_{}_{}_{}_log.txt'.format(args.student_model, args.student_backbone, args.dataset))
